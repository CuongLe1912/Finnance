...
namespace Finnance.CuongLe.Middlewares
{
    public class LoggerMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly IServiceProvider _serviceProvider;
        private readonly string[] ignores = new string[] { "/lookup", "/getall", "/items", "/utility", "/log", "/upload", "/import", "/notifyhub", "mlarticle", "/msupload", "/msseo", "/mshighlight", "ImportData" };
